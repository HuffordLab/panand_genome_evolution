...
setwd("C:\\Users\\Armin\\ws\\panand\\analysis\\panand_cns_analysis\\3_conserved_sequences")
...
tree<-read.tree("data\\tree\\panand_neutral_tree.nwk")
cons <- read.delim("phastcons\\filtered/phastcons_panand_raw_noncoding_annot_closestGene_classes_blastxfilt_cov_05102023.bed.wextraznicar.stats.txt",sep='\t',header=TRUE)
cns <- read.delim("phastcons\\filtered\\phastcons_panand_raw_noncoding_annot_closestGene_classes_blastxfilt_cov_05102023.wextraznicar.bed",sep='\t',header=FALSE)
